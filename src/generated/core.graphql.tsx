...
export type MutationAddDoctorAvailArgs = {
...
export type BookAppointmentMutation = { __typename?: 'Mutation', bookAppointment: { __typename?: 'Appointment', id: number, patientName: string, description: string, doctorId: number, startTime: any, durationMinutes: number, doctor: { __typename?: 'Doctor', id: number } } };

export type AddDoctorAvailMutationVariables = Exact<{
  dayOfWeek: Scalars['Float'];
  startTimeUtc: Scalars['String'];
  endTimeUtc: Scalars['String'];
  doctorId: Scalars['Float'];
...
export type AddDoctorAvailMutation = { __typename?: 'Mutation', addDoctorAvail: { __typename?: 'Doctor', id: number, name: string } };
...
export const AddDoctorAvailDocument = gql`
    mutation AddDoctorAvail($dayOfWeek: Float!, $startTimeUtc: String!, $endTimeUtc: String!, $doctorId: Float!) {
  addDoctorAvail(
    dayOfWeek: $dayOfWeek
    ...
    `;
export type AddDoctorAvailMutationFn = Apollo.MutationFunction<AddDoctorAvailMutation, AddDoctorAvailMutationVariables>;

/**
 * __useAddDoctorAvailMutation__
 *
 * To run a mutation, you first call `useAddDoctorAvailMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddDoctorAvailMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [addDoctorAvailMutation, { data, loading, error }] = useAddDoctorAvailMutation({
 *   variables: {
 *      dayOfWeek: // value for 'dayOfWeek'
 *      startTimeUtc: // value for 'startTimeUtc'
 *      endTimeUtc: // value for 'endTimeUtc'
 *      doctorId: // value for 'doctorId'
 *   },
 * });
 */
export function useAddDoctorAvailMutation(baseOptions?: Apollo.MutationHookOptions<AddDoctorAvailMutation, AddDoctorAvailMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddDoctorAvailMutation, AddDoctorAvailMutationVariables>(AddDoctorAvailDocument, options);
      }
export type AddDoctorAvailMutationHookResult = ReturnType<typeof useAddDoctorAvailMutation>;
export type AddDoctorAvailMutationResult = Apollo.MutationResult<AddDoctorAvailMutation>;
export type AddDoctorAvailMutationOptions = Apollo.BaseMutationOptions<AddDoctorAvailMutation, AddDoctorAvailMutationVariables>;
